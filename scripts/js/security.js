class FormSecurity {
    constructor(){
        this.field_names = ["name", "email", "message"]; //Place your contact form field NAMES into this array
        this.tracker_test = true;
        this.trackers = [
    ...
    loadFormWithJavaScript(){
        $.get("scripts/html/form.html", (html) => {
            ...
            if (this.tracker_test === true){
                this.trackerTest();
            } else if (this.tracker_test == true){
                this.enableForm();
            }
        });
    }
    ...
    enableForm(){
        ...
        this.field_names.forEach(function(elem_name){
