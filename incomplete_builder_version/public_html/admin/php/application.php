...
<link href="/assets/jquery_ui/jquery-ui.css" rel="stylesheet">
...
if (file_exists(dirname($_SERVER["DOCUMENT_ROOT"], 1) . "/true_user/user.php")){
    echo '<label for="old_password" class="form-label">Old password: </label>
...
<input type="password" name="new_password_confirm" id="new_password_confirm" class="form-control" value="">

    <div class="btn-group mt-3">
        <button type="button" id="change_password_button" class="btn btn-primary">Change Password</button>
    </div>
...
<script src="/admin/js/application.js"></script> <!--Main application js file, NOT BOOTSTRAP RELATED-->
<script>
