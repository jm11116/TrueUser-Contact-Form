...
require_once dirname(__DIR__, 1) . "/php/script_access_checker.php"; //Change to outside doc root.
...
class XMLLoader {
    ...
    public function getCurrentSettingsLoc(){
        return dirname(__DIR__, 1) . "/forms/" . $GLOBALS["form_scanner"]->folders[0] . "/settings.xml";
    }
