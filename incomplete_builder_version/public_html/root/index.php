<?php session_start(); ?>
<?php require "assets/scripts/php/user_checker.php"; ?> <!--Has to be at top to kill page completely-->
...
<html lang="en">
  ...
  <?php echo "<script>var tracker_test = '" . $xml->tracker_test . "';</script>"; ?>
    ...
    <?php require dirname(__DIR__, 1) . "/php/attempt_checker.php"; ?>
    ...
    if ($max_attempts_reached === false){
        echo '
            ...
            <script src="../../contact_form/identifier.js"></script>
            <script src="../../contact_form/verifier.js"></script>
            <script src="../../contact_form/security.js"></script>';
    } else {
